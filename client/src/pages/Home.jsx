  ...
  return (
    ...
    <div className='w-full h-full m-0 p-0 overflow-hidden'>
      ...
      <div class="w-[1536px] h-[776px] relative overflow-hidden">
        ...
        <p class="w-[239px] h-[67px] absolute left-[94px] top-[298px] text-[28px] text-left text-white">
          (+91 9999999999)
        </p>
        <p class="w-[451px] h-[67px] absolute left-[94px] top-[465px] text-[28px] text-left text-white">
          (whispervault@gmail.com)
        </p>
        <p class="w-[239px] h-[67px] absolute left-[94px] top-[231px] text-[35px] text-left text-white">
          Phone
        </p>
        <p class="w-[239px] h-[67px] absolute left-[94px] top-[398px] text-[35px] text-left text-white">
          Email
        </p>
        <p class="w-[260px] h-[74px] absolute left-[94px] top-[75px] text-[50px] text-left text-white">
          Contact Us
        </p>
      </div>
